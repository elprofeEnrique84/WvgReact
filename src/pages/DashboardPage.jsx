...
export const DashboardPage = () => {
  ...
  const completionRate = kpis.total > 0 ? ((kpis.completados / kpis.total) * 100).toFixed(1) : 0;
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Resumen del sistema de mantenimientos</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Últimos Mantenimientos</h2>
              ...
              <tbody>
                {mantenimientos.slice(0, 5).map((mant) => (
                  <tr key={mant.id_mantencion} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-gray-600">{mant.usuario?.nombre_usuario || 'N/A'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
